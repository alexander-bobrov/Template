...
using Template.Services.SmtpService;
...
namespace Template.Services.MailService
{
    public class SmtpService : IHostedService, IDisposable
    {
        ...
        public SmtpService(ILogger<SmtpService> logger, IOptions<SmtpOptions> options, IDbContextFactory<TemplateContext> dbFactory)
        {
